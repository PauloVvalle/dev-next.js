...
function Bottom() {
    ...
    return (
        <div className={`fixed bottom-0 left-0 z-50 w-full h-16
         ...
         `}>
        <ul className="grid h-full max-w-lg grid-cols-4 mx-auto pt-3 font-medium">
            <li>
            ...
            <li>
            <a href="/products" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">


                <svg class="w-5 h-5 mb-2 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
            ...
            <li>
            <a href="/cart" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
